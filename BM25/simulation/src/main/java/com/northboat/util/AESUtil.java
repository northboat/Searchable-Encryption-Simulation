...
public class AESUtil {
    ...
    // 加密
    public static String encrypt(String content) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException { // 加密
        return Base64.encodeBase64String(aes(content.getBytes(charset), Cipher.ENCRYPT_MODE, secretKey, iv));
    }

    // 解密
    public static String decrypt(String contentArray) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException { // 解密
